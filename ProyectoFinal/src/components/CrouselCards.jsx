import '../styles/CrouselCards.css'

function CrouselCards() {
  return (
    <div>
        ...
        <div className="carousel-inner">
          ...
          {/* Aquí empieza una nueva diapositiva del carrusel */}
          <div className="carousel-item">
            <div className='cards-wrapper'>
              ...
              <div className="card">
                <img src="/src/img/WhatsApp Image 2024-09-13 at 1.37.39 PM (6).jpeg" className="card-img-top" alt="..." />
                <div className="card-body">
                  <h5 className="card-title">Card title</h5>
                  <p className="card-text">Some quick example text to build on the card title and make up the bulk of the cards content.</p>
                  <a href="#" className="btn btn-primary">Comprar</a>
          ...
          {/* Agrega más "carousel-item" aquí según sea necesario */}
        </div>
